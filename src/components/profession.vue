...
<li>Make sure all forms are completed and filled before the closing date.</li>
  ...
  <div class="card-header font-weight-bold">Professional History</div>
  <div class="card-body text-secondary">
	...
	<div class="form-row">
      ...
      <b-form-checkbox-group stacked v-model="selected" name="flavour2" :options="qualify">
	  ...
	  <div class="form-row">
	   ...
	   <b-col md="6">
	    <b-form-group label="Relevant Skills ">
     <b-form-checkbox-group stacked v-model="selected" name="flavour2" :options="rskills">
      </b-form-checkbox-group>
    </b-form-group>
      ...
      <button @click.prevent="next()" type="button" class="btn btn-info btn-sm">Next</button>
    ...
    return {
     form: {
	  ...
	  rskills: [
        ...
        { value: 'Finance/Accounts', text: 'Finance/Accounts' }
